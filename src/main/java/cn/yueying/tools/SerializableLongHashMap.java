 ...
 *            The class to store.
 */
public final class SerializableLongHashMap<T> implements java.io.Serializable {
	private static final long serialVersionUID = 3837381665559058550L;
	...
	public SerializableLongHashMap() {
		this(16);
	}

	@SuppressWarnings("unchecked")
	public SerializableLongHashMap(int capacity) {
	...
	public void logStats() {
		...
		DaoLog.d("load: " + ((float) size) / capacity + ", size: " + size + ", capa: " + capacity
				+ ", collisions: " + collisions + ", collision ratio: " + ((float) collisions)
				/ size);
	}
